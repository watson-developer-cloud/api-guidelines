...
All names specified in path and query parameters, resource names, and JSON input and output fields must use "snake_case" and must not use abbreviations or acronyms.
